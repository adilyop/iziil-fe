...
export default function HomePage() {
  return (
    <DefaultTemplate>
      ...
      <div className="mt-12 text-base	 xl:text-4xl text-black text-center font-medium ">Une suite Web pour gérer l'ensemble de votre entreprise </div>
      <div className="mt-2 text-xs xl:text-base	 text-center text-blue-700">(TPE, PME, grandes entreprises, indépendants, associations)</div>
      ...
      <div className="bg-white mt-12 xl:text-xl text-base text-black">
        <div className="text-white text-base xl:text-3xl w-4/5	mt-12 xl:mt-24 mb-12 ml-12 p-4 bg-gradient-to-r from-blue-900	to to-white font-bold	 ">Avantages</div>
        <div className="bg-white">
          <div className="xl:px-20 px-4 ">
            <div className="font-bold	 text-base xl:text-2xl xl:m-12 m-4 flex items-center	">
              <img src="https://flowbite.com/docs/images/logo.svg" className="mr-3 h-8 xl:h-16" alt="Flowbite Logo" />
        ...
        <div className="text-white text-base xl:text-3xl w-4/5	mt-12 xl:mt-24 mb-12 ml-12 p-4 bg-gradient-to-r from-blue-900	to to-white font-bold	">Fonctionnalités</div>

        <div className="bg-white">
          <div className="xl:px-20 px-4">
            <div className="font-bold	text-xs xl:text-base xl:text-2xl xl:m-12 m-4 flex items-center	">
              <img src="https://flowbite.com/docs/images/logo.svg" className="mr-3 h-8 xl:h-16" alt="Flowbite Logo" />
              CRM & Ventes...</div>
            <div className="inline-flex	text-base">
              <div className="border border-sky-200	 bg-sky-50 p-0.5 w-16 h-16 m-2 xl:p-4 xl:w-32 xl:h-32 xl:m-4 shadow">
                <div className="text-center flex items-center	justify-center    h-2/5 xl:text-base text-[8px] leading-normal">Devis</div>
                <div className="flex items-center	justify-center	 h-3/5">
                  <svg className="xl:w-10 xl:h-10 w-10 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                    <path d="M16 0H4a2 2 0 0 0-2 2v1H1a1 1 0 0 0 0 2h1v2H1a1 1 0 0 0 0 2h1v2H1a1 1 0 0 0 0 2h1v2H1a1 1 0 0 0 0 2h1v1a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2Zm-5.5 4.5a3 3 0 1 1 0 6 3 3 0 0 1 0-6ZM13.929 17H7.071a.5.5 0 0 1-.5-.5 3.935 3.935 0 1 1 7.858 0 .5.5 0 0 1-.5.5Z" />
                  </svg>
                </div>
              </div>
              <div className="border border-sky-200	 bg-sky-50 p-0.5 w-16 h-16 m-2 xl:p-4 xl:w-32 xl:h-32 xl:m-4 shadow">
                <div className="text-center flex items-center	justify-center    h-2/5 xl:text-base text-[8px] leading-normal">Commandes</div>
                <div className="flex items-center	justify-center	 h-3/5">
                  <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m-4 4H1m3 4H1m3 4H1m3 4H1m6.071.286a3.429 3.429 0 1 1 6.858 0m-4 1h12a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1Zm9 6.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z" />
                  </svg>
                </div>
              </div>
              <div className="border border-sky-200	 bg-sky-50 p-0.5 w-16 h-16 m-2 xl:p-4 xl:w-32 xl:h-32 xl:m-4 shadow">
                <div className="text-center flex items-center	justify-center    h-2/5 xl:text-base text-[8px] leading-normal">Contrats</div>
                <div className="flex items-center	justify-center	 h-3/5">
          ...
          <div className="xl:px-20 px-4">
            ...
            <div className="inline-flex	text-base">
              <div className="border border-sky-200	 bg-sky-50 p-0.5 w-16 h-16 m-2 xl:p-4 xl:w-32 xl:h-32 xl:m-4 shadow">
                <div className="text-center flex items-center	justify-center    h-2/5 xl:text-base text-[8px] leading-normal">Notes de frais</div>
                <div className="flex items-center	justify-center	 h-3/5">
                  <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7.75 4H19M7.75 4a2.25 2.25 0 0 1-4.5 0m-4.5 0a2.25 2.25 0 0 0-4.5 0M1 4h2.25m13.5 6H19m-2.25 0a2.25 2.25 0 0 1-4.5 0m-4.5 0a2.25 2.25 0 0 0-4.5 0M1 10h11.25m-4.5 6H19M7.75 16a2.25 2.25 0 0 1-4.5 0m-4.5 0a2.25 2.25 0 0 0-4.5 0M1 16h2.25" />
                  </svg>
                </div>
              </div>
              <div className="border border-sky-200	 bg-sky-50 p-0.5 w-16 h-16 m-2 xl:p-4 xl:w-32 xl:h-32 xl:m-4 shadow">
                <div className="text-center flex items-center	justify-center    h-2/5 xl:text-base text-[8px] leading-normal">Feuilles de temps</div>
                <div className="flex items-center	justify-center	 h-3/5">
                  <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="border border-sky-200	 bg-sky-50 p-0.5 w-16 h-16 m-2 xl:p-4 xl:w-32 xl:h-32 xl:m-4 shadow">
                <div className="text-center flex items-center	justify-center    h-2/5 xl:text-base text-[8px] leading-normal">Demande de congés</div>
                <div className="flex items-center	justify-center	 h-3/5">
                  <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m-4 12.25V1m0 11.25a2.25 2.25 0 0 0 0 4.5m0-4.5a2.25 2.25 0 0 1 0 4.5m-4 19v-2.25m6-13.5V1m0 2.25a2.25 2.25 0 0 0 0 4.5m0-4.5a2.25 2.25 0 0 1 0 4.5M10 19V7.75m6 4.5V1m0 11.25a2.25 2.25 0 1 0 0 4.5 2.25 2.25 0 0 0 0-4.5ZM16 19v-2" />
                  </svg>
                </div>
              </div>
              <div className="border border-sky-200	 bg-sky-50 p-0.5 w-16 h-16 m-2 xl:p-4 xl:w-32 xl:h-32 xl:m-4 shadow">
                <div className="text-center flex items-center	justify-center    h-2/5 xl:text-base text-[8px] leading-normal">Employées</div>
                <div className="flex items-center	justify-center	 h-3/5">
          ...
          <div className="xl:px-20 px-4">
            ...
            <div className="inline-flex	text-base">
              <div className="border border-sky-200	 bg-sky-50 p-0.5 w-16 h-16 m-2 xl:p-4 xl:w-32 xl:h-32 xl:m-4 shadow">
                <div className="text-center flex items-center	justify-center    h-2/5 xl:text-base text-[8px] leading-normal">Produits</div>
                <div className="flex items-center	justify-center	 h-3/5">
              ...
              <div className="border border-sky-200	 bg-sky-50 p-0.5 w-16 h-16 m-2 xl:p-4 xl:w-32 xl:h-32 xl:m-4 shadow">
                <div className="text-center flex items-center	justify-center    h-2/5 xl:text-base text-[8px] leading-normal">Stocks</div>
                <div className="flex items-center	justify-center	 h-3/5">
                  <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 8 14">
              ...
              <div className="border border-sky-200	 bg-sky-50 p-0.5 w-16 h-16 m-2 xl:p-4 xl:w-32 xl:h-32 xl:m-4 shadow">
                <div className="text-center flex items-center	justify-center    h-2/5 xl:text-base text-[8px] leading-normal">Achats</div>
                <div className="flex items-center	justify-center	 h-3/5">
                  <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 8">
          ...
          <div className="xl:px-20 px-4">
            ...
            <div className="inline-flex	text-base">
              <div className="border border-sky-200	 bg-sky-50 p-0.5 w-16 h-16 m-2 xl:p-4 xl:w-32 xl:h-32 xl:m-4 shadow">
                <div className="text-center flex items-center	justify-center    h-2/5 xl:text-base text-[8px] leading-normal">Facturation</div>
                <div className="flex items-center	justify-center	 h-3/5">
              ...
              <div className="border border-sky-200	 bg-sky-50 p-0.5 w-16 h-16 m-2 xl:p-4 xl:w-32 xl:h-32 xl:m-4 shadow">
                <div className="text-center flex items-center	justify-center    h-2/5 xl:text-base text-[8px] leading-normal">Comptabilité</div>
                <div className="flex items-center	justify-center	 h-3/5">
          ...
          <div className="xl:px-20 px-4">
            ...
            <div className="inline-flex	text-base">
              <div className="border border-sky-200	 bg-sky-50 p-0.5 w-16 h-16 m-2 xl:p-4 xl:w-32 xl:h-32 xl:m-4 shadow">
                <div className="text-center flex items-center	justify-center    h-2/5 xl:text-base text-[8px] leading-normal">Emailing</div>
                <div className="flex items-center	justify-center	 h-3/5">
          ...
          <div className="xl:px-20 px-4">
            ...
            <div className="inline-flex	text-base">
              <div className="border border-sky-200	 bg-sky-50 p-0.5 w-16 h-16 m-2 xl:p-4 xl:w-32 xl:h-32 xl:m-4 shadow">
                <div className="text-center flex items-center	justify-center    h-2/5 xl:text-base text-[8px] leading-normal">Projets</div>
                <div className="flex items-center	justify-center	 h-3/5">
                  <svg className="xl:w-10 xl:h-10 w-10 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                    <path d="M16 0H4a2 2 0 0 0-2 2v1H1a1 1 0 0 0 0 2h1v2H1a1 1 0 0 0 0 2h1v2H1a1 1 0 0 0 0 2h1v2H1a1 1 0 0 0 0 2h1v1a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2Zm-5.5 4.5a3 3 0 1 1 0 6 3 3 0 0 1 0-6ZM13.929 17H7.071a.5.5 0 0 1-.5-.5 3.935 3.935 0 1 1 7.858 0 .5.5 0 0 1-.5.5Z" />
                  </svg>
              ...
              <div className="border border-sky-200	 bg-sky-50 p-0.5 w-16 h-16 m-2 xl:p-4 xl:w-32 xl:h-32 xl:m-4 shadow">
                <div className="text-center flex items-center	justify-center    h-2/5 xl:text-base text-[8px] leading-normal">Taches</div>
                <div className="flex items-center	justify-center	 h-3/5">
                  <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                    <path stroke="currentColor" stroke-linejoin="round" stroke-width="2" d="M8 8v1h4V8m-4 7H4a1 1 0 0 1-1-1V5h14v9a1 1 0 0 1-1 1ZM2 1h16a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1Z" />
                  </svg>
                </div>
              </div>
              <div className="border border-sky-200	 bg-sky-50 p-0.5 w-16 h-16 m-2 xl:p-4 xl:w-32 xl:h-32 xl:m-4 shadow">
                <div className="text-center flex items-center	justify-center    h-2/5 xl:text-base text-[8px] leading-normal">Agenda</div>
                <div className="flex items-center	justify-center	 h-3/5">
                  <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                    <path stroke="currentColor" stroke-linejoin="round" stroke-width="2" d="M8 8v1h4V8m-4 7H4a1 1 0 0 1-1-1V5h14v9a1 1 0 0 1-1 1ZM2 1h16a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1Z" />
                  </svg>
